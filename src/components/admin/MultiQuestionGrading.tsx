  ...
  return (
    <div className="flex-1 space-y-8">
      ...
      <div className="animate-slide-up">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400">Multi-Question Assessment</p>
      </div>
      ...
      <div className="glass-card p-8 animate-scale-in transition-all duration-300 border-white/40">
         <div className="flex items-center gap-3 mb-6">
             ...
             <h3 className="text-xl font-bold text-slate-900 dark:text-slate-200">Question Scorer</h3>
         </div>
