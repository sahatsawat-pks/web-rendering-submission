...
async function ensureTables() {
    ...
    try {
        ...
        await client.query(`
            UPDATE subjects SET has_grading_interface=true, grading_type='simple_score', has_quiz_management=true, has_test_cases=true WHERE code='ITCS123' AND grading_type IS NULL;
            UPDATE subjects SET grading_type='simple_score' WHERE code='ITCS123' AND grading_type = 'lab_challenge';
