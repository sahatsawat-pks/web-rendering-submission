...
export default function StudentStatusPage() {
  ...
  async function handleSearch(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/scores?subject=ITCS227&username=${studentId}`)
      if (res.ok) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans p-6 md:p-12">
      <div className="max-w-4xl mx-auto space-y-8 animate-slide-up">
        ...
        {/* Search Box */}
        <div className="glass-card p-2 rounded-2xl shadow-lg shadow-purple-500/10 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
