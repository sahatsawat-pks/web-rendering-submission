         ...
         <div className="glass-card p-2 rounded-2xl shadow-lg shadow-blue-500/10 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 mb-8">
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-2">
                ...
                <button 
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 justify-center shrink-0 shadow-lg shadow-blue-500/30"
                >
      ...
      <main className="container mx-auto max-w-7xl px-6 py-16 relative z-10">
        <div className="mx-auto max-w-3xl mb-16 text-center animate-slide-up">
          <h1 className="text-6xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100 sm:text-7xl mb-6">
            ITCS251 <span className="gradient-text">Score Check</span>
          </h1>
        </div>
