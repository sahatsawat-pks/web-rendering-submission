       ...
       <nav className="sticky top-0 z-50 w-full glass border-b border-white/30 dark:border-slate-700/50 shadow-lg">
        <div className="container mx-auto max-w-7xl flex h-16 items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <img src="/logo.png" alt="Logo" className="h-11 w-11 rounded-xl shadow-lg shadow-blue-500/20" />
            <div>
      ...
      <main className="container mx-auto px-6 py-24 flex flex-col items-center justify-center min-h-[80vh]">
        <div className="text-center mb-16 animate-slide-up">
           <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 dark:text-slate-100 mb-6 tracking-tight">
              Select <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-sky-500">Action</span>
           </h1>
           <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Choose to run Python tests or check your lab scores.
           </p>
        </div>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl animate-scale-in ${quizSectionEnabled ? 'lg:grid-cols-3' : 'lg:grid-cols-2'}`}>
           ...
           <Link href="/itcs251/test-case" className="group relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                 ...
                 <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-3">Python Test Runner</h2>
                 <p className="text-slate-500 dark:text-slate-400">
                    Execute and test your Python code with automated test cases.
                 </p>
              </div>
           </Link>

           {/* Card 2: Scores */}
           <Link href="/itcs251/score" className="group relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                 ...
                 <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-3">Check <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-sky-500">Lab Scores</span></h2>
                 <p className="text-slate-500 dark:text-slate-400">
