      ...
      <main className="container mx-auto max-w-7xl px-4 py-8 flex flex-col lg:flex-row gap-8 relative z-10">
        ...
        <div className="flex-1 space-y-8">
          ...
          <div className="animate-slide-up">
            <h1 className="text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-100 mb-2">ITGE162 Dashboard</h1>
          ...
          <div className="glass-card p-8 animate-scale-in hover:shadow-2xl hover:shadow-teal-500/5 transition-all duration-300 border-white/40">
            <div className="flex items-center justify-between mb-8">
              <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                ...
                Rate Student Lab (ITGE162)
              </h3>
              <span className="px-3 py-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg text-xs font-medium border border-blue-200 dark:border-blue-800 shadow-sm">
                Sheets Mode
              </span>
            </div>
            ...
            <form onSubmit={handleGradeSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full md:w-auto px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 rounded-xl shadow-md shadow-teal-500/30 transition-all btn-hover-lift flex items-center justify-center gap-2"
              >
