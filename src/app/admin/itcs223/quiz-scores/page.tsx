...
export default function ITCS223QuizScoresPage() {
  ...
  const exportToCSV = () => {
    ...
    a.href = url
    a.download = `itcs223-quiz-scores-${selectedLab}-${new Date().toISOString().split('T')[0]}.csv`
    a.click()
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-950">
      {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-purple-500 hover:text-white transition-all"
              >
